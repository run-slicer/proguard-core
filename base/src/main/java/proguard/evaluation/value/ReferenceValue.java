...
public abstract class ReferenceValue extends Category1Value {
  ...
  public abstract ReferenceValue cast(
  ...
  // Similar binary methods, but this time with reference arguments that can have multiple possible
  // types.
  /**
   * Returns the generalization of this {@link ReferenceValue} and the given other {@link
  ...
  /**
   * Returns whether this {@link ReferenceValue} is equal to the given other {@link
   * MultiTypedReferenceValue}.
   *
   * @return <code>NEVER</code>, <code>MAYBE</code>, or <code>ALWAYS</code>.
   */
