...
public class ClassReferenceFixer
  ...
  public void visitDynamicConstant(Clazz clazz, DynamicConstant dynamicConstant) {
    ...
    String newDescriptor = newDescriptor(descriptor, dynamicConstant.referencedClasses);
  ...
  public void visitInvokeDynamicConstant(Clazz clazz, InvokeDynamicConstant invokeDynamicConstant) {
    ...
    String newDescriptor = newDescriptor(descriptor, invokeDynamicConstant.referencedClasses);
  ...
  public void visitMethodTypeConstant(Clazz clazz, MethodTypeConstant methodTypeConstant) {
    ...
    String newDescriptor = newDescriptor(descriptor, methodTypeConstant.referencedClasses);
  ...
  public void visitSignatureAttribute(Clazz clazz, SignatureAttribute signatureAttribute) {
    ...
    String newSignature = newDescriptor(signature, signatureAttribute.referencedClasses);
  ...
  public void visitInnerClassesInfo(Clazz clazz, InnerClassesInfo innerClassesInfo) {
    ...
    if (innerClassIndex != 0 && innerNameIndex != 0) {
      ...
      if (index >= 0) {
        innerClassesInfo.u2innerNameIndex =
            new ConstantPoolEditor((ProgramClass) clazz)
                .addUtf8Constant(newInnerName.substring(index + 1));
      }
    }
  }
   ...
   *
   * <p>Mangled names are generated by the Kotlin compiler to avoid name clashes; these names are
   * the same as the original names, but with a suffix appended.
   *
   * <p>The function name in the Kotlin metadata should use the demangled name.
   */
