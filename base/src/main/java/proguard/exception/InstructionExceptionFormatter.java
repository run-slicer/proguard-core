 ...
 * {@link proguard.evaluation.PartialEvaluator} and {@link
 * proguard.classfile.attribute.visitor.StackSizeComputer} to print the erroneous instruction and
...
public class InstructionExceptionFormatter {
  ...
  public InstructionExceptionFormatter(
      Logger logger, CircularIntBuffer offsetBuffer, byte[] code, Clazz clazz, Method method) {
    this.logger = logger;
  ...
  public void printException(
      ProguardCoreException exception, TracedVariables variables, TracedStack stack) {
    ...
    logger.warn(messageBuilder.toString(), exception);
  }
}
